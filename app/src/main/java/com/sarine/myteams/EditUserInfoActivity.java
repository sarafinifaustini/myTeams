...
public class EditUserInfoActivity  extends AppCompatActivity{
        ...
        private void init() {
            ...
            txtSelectPhoto.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    i.setType("image/*");
                    EditUserInfoActivity.this.startActivityForResult(i, GALLERY_CHANGE_PROFILE);
                }
            });
            ...
            btnSave.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    if (EditUserInfoActivity.this.validate()) {
                        EditUserInfoActivity.this.updateProfile();
                    }
                }
            });
        }
        ...
        private void updateProfile(){
            ...
            dialog.show();
            StringRequest request = new StringRequest(Request.Method.POST, constants.SAVE_USER_INFO, new Response.Listener<String>() {
                @Override
